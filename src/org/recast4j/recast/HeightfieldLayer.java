...
public class HeightfieldLayer {
    public final Vector3f bmin = new Vector3f(); /// < The minimum bounds in world space. [(x, y, z)]
    public final Vector3f bmax = new Vector3f(); /// < The maximum bounds in world space. [(x, y, z)]
