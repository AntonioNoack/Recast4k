...
object RecastConstants {
    ...
    var RC_CONTOUR_TESS_WALL_EDGES = 0x01 /// < Tessellate solid (impassable) edges during contour

    /// simplification.
    var RC_CONTOUR_TESS_AREA_EDGES = 0x02 /// < Tessellate edges between areas during contour
